...
class RCStackCompatTest(unittest.TestCase):
    ...
    def test_finetune_qwen35_only_disables_seq_packing(self):
        ...
        args = OmegaConf.create(base_args)

        finetune_loop._apply_finetune_model_compat_overrides(args)

        self.assertTrue(args.use_flash_attention)
        self.assertEqual(args.attn_implementation, "flash_attention_2")
        self.assertFalse(args.seq_packing)
